...
const ParentResult = () => {
  ...
  const term = Number(location.state?.term || auth?.allowedTerms?.[0]);
  ...
  const gradeLegendData = [
    ...
    { key: "6", grade: "C6", rate: '50-59 "CREDIT"' },
    { key: "7", grade: "D7", rate: '45-49 "PASS"' },
    { key: "8", grade: "E8", rate: '40-44 "FAIR"' },
    { key: "9", grade: "F9", rate: '0-39 "FAIL"' },
  ];
